    ...
    try {
      ...
      setState(() {
        jobs = demands.map((d) {
          return {
            ...
            'homeowner_name': d['homeowners']?['users']?['full_name'] ?? 'Anonymous',
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('Failed to load demands: ${e.toString().replaceAll('Exception: ', '')}'),
                    ...
                    children: [
                      ...
                      if (selectedCategory != null || selectedWilaya != null)
                        TextButton.icon(
                          ...
                          icon: const Icon(Icons.clear, size: 18, color: Color(0xFF4CAF50)),
                          label: const Text(
                            'Clear',
                          ...
                          child: DropdownButton<String>(
                            ...
                            items: categories.map((category) {
                              return DropdownMenuItem(
                                value: category['id'],
                                child: Text(_getLocalizedCategory(category['name']!, l10n)),
                              );
                            }).toList(),
                            onChanged: (value) {
                              setState(() {
                        ...
                        : ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return JobCard(
                                ...
                                l10n: l10n,
                                onOfferSent: _loadDemands, // Refresh after sending offer
                              );
                            },
                          ),
              ),
          ...
          children: [
            TextField(
              ...
              decoration: InputDecoration(
                ...
                hintText: 'e.g., 2500',
                prefixIcon: const Icon(Icons.payments, color: Color(0xFF4CAF50)),
                border: OutlineInputBorder(
