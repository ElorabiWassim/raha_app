...
class AppLocalizationsAr extends AppLocalizations {
  ...
  String get onboardingSubtitle1 =>
      'احجز بسهولة محترفين محليين معتمدين لجميع احتياجات منزلك.';
  ...
  String get onboardingSubtitle3 =>
      'شارك تجربتك وساعد الآخرين على اتخاذ خيارات مدروسة.';
  ...
  String get loginInvalidUsername =>
      'اسم المستخدم غير صحيح. يرجى استخدام: homeowner أو serviceprovider أو admin';
  ...
  String get tipClearPricing =>
      'استخدم تنسيقات تسعير واضحة مثل \"1500 دج\" أو \"للساعة\"';
  ...
  String get addPhotosToAttractCustomers =>
      'أضف صورًا لأعمالك لجذب المزيد من العملاء.';
  ...
  String get planFreeFeatures =>
      'إنشاء حساب وإدراج ما يصل إلى 3 خدمات.|إدراج معلومات الاتصال.|أولوية عرض منخفضة.|مجاناً لمدة 6 أشهر لأول 20 مشتركاً.';

  @override
  String get planProFeatures =>
      'إدراج ما يصل إلى 10 خدمات.|تلقي الحجوزات والرسائل.|إنشاء المنشورات.|الرد على طلبات المستخدمين.|أولوية عرض متوسطة.';

  @override
  String get planEliteFeatures =>
      'إدراج ما يصل إلى 20 خدمة.|عرض إحصائيات مفصلة للملف الشخصي.|أولوية عرض عالية في النتائج.|الحصول على شارة التوثيق.|ترويج الخدمات عبر الإعلانات.';
